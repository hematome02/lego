...
for (const com of communityName) {
  communities[com].deals.sort((a, b) => b.price - a.price);
  
  console.log(`Deals for ${com} sorted by price (highest to lowest):`);
...
console.log(VINTED.find(item => item.uuid === "f2c5377c-84f9-571d-8712-98902dcbb913"));

// 🎯 TODO 14: Delete a specific item
// 1. Delete the item with the uuid `f2c5377c-84f9-571d-8712-98902dcbb913`
// 2. Log the new list of items

console.log(VINTED.length);
const newVINTED = VINTED.filter(item => item.uuid !== "f2c5377c-84f9-571d-8712-98902dcbb913" ); 
console.log(newVINTED.length);
...
const myFavoriteDealers = JSON.parse(localStorage.getItem('MY_FAVORITE_DEALERS'));
console.log("MY_FAVORITE_DEALERS dans le localStorage :", myFavoriteDealers);
